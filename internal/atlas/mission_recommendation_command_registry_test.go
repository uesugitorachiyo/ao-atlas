...
func TestMissionRecommendationCommandRegistryDrivesDeterministicDispatchHelp(t *testing.T) {
	...
	for _, want := range []string{
		...
		"replayable-state-packet-fixture",
		"indexed-event-query-fixture",
		"atomic-evidence-transition-fixture",
		"local-backup-restore-fixture",
		"command-readback-adapter-boundary-fixture",
		"compact-timeline-filter-fixture",
		"authority-readiness-inventory-fixture",
		"content-addressed-evidence-manifest-fixture",
		"foundry-evidence-size-boundary-fixture",
		"repeated-task-result-ledger-fixture",
		"failure-injection-fuzzing-fixture",
		"local-platform-fixture",
		"non-ao-replay-binding-fixture",
		"kill-restart-replay-fixture",
		"rollback-terminal-readback-fixture",
		"golden-path-readiness-matrix",
		"month3-final-closure-rollup",
		"month3-terminal-digest-binding",
		"month3-non-ao-dry-run-replay",
		"month3-real-run-acceptance",
		"month3-control-plane-observer",
		"month3-schema-owner-registry",
		"month3-evidence-externalization",
		"month3-cross-repo-ci-matrix",
	...
	if !strings.Contains(text, "mission recommendations requires import, export-next-wave, export-refactoring-wave") ||
		!strings.Contains(text, "mission-dashboard-compact-filters, bounded-signer-contract-fixture, canonical-contract-registry-manifest, contract-compatibility-inventory, canonical-json-vectors, canonical-json-vector-smoke-checks, sentinel-hosted-ci-workflow-fixture, sentinel-signal-state-fixture, signed-assurance-dry-run-fixture, promoter-no-activation-boundary-fixture, workspace-root-preflight-fixture, bounded-execution-packet-fixture, forge-goalrun-evidence-fixture, execution-packet-regression-matrix, durable-state-migration-metadata, exactly-once-resume-accounting-fixture, replayable-state-packet-fixture, indexed-event-query-fixture, atomic-evidence-transition-fixture, local-backup-restore-fixture, command-readback-adapter-boundary-fixture, compact-timeline-filter-fixture, authority-readiness-inventory-fixture, content-addressed-evidence-manifest-fixture, foundry-evidence-size-boundary-fixture, repeated-task-result-ledger-fixture, failure-injection-fuzzing-fixture, local-platform-fixture, non-ao-replay-binding-fixture, kill-restart-replay-fixture, rollback-terminal-readback-fixture, golden-path-readiness-matrix, month3-final-closure-rollup, month3-terminal-digest-binding, month3-non-ao-dry-run-replay, month3-real-run-acceptance, month3-control-plane-observer, month3-schema-owner-registry, month3-evidence-externalization, month3-cross-repo-ci-matrix, month3-operator-dashboard-readback, month3-restart-resume-soak, month3-provider-model-provenance, month3-rollback-replay-negative, month3-architecture-source-truth, blueprint-canonical-preservation-fixture, foundry-canonical-import-fixture, command-covenant-field-parity-fixture, complete-node, resume, or validate-evidence") {
