...
type AtlasTicketDigestReadbackBindingInput struct {
	Schema                 string                                 `json:"schema"`
	Status                 string                                 `json:"status"`
	Cases                  []AtlasTicketDigestReadbackBindingCase `json:"cases"`
	SchedulesWork          bool                                   `json:"schedules_work"`
	ExecutesWork           bool                                   `json:"executes_work"`
	ApprovesWork           bool                                   `json:"approves_work"`
	ClaimsAuthorityAdvance bool                                   `json:"claims_authority_advance"`
...
type AtlasTicketDigestReadbackBindingCase struct {
	ID                   string `json:"id"`
	CommandReadbackPath  string `json:"command_readback_path"`
	CovenantReadbackPath string `json:"covenant_readback_path"`
	CommandTicketSHA256  string `json:"command_ticket_sha256"`
	CovenantTicketSHA256 string `json:"covenant_ticket_sha256"`
}

type AtlasTicketDigestReadbackBindingFixture struct {
	Schema                 string                                 `json:"schema"`
	Status                 string                                 `json:"status"`
	SourceInputPath        string                                 `json:"source_input_path"`
	SourceInputDigest      string                                 `json:"source_input_digest"`
	CaseCount              int                                    `json:"case_count"`
	MismatchedCases        int                                    `json:"mismatched_cases"`
	DigestBindingPassed    bool                                   `json:"digest_binding_passed"`
	Cases                  []AtlasTicketDigestReadbackBindingCase `json:"cases"`
	SchedulesWork          bool                                   `json:"schedules_work"`
	ExecutesWork           bool                                   `json:"executes_work"`
	ApprovesWork           bool                                   `json:"approves_work"`
...
type AtlasPolicyVersionReplayRejectionInput struct {
	Schema                 string                                  `json:"schema"`
	Status                 string                                  `json:"status"`
	Cases                  []AtlasPolicyVersionReplayRejectionCase `json:"cases"`
	SchedulesWork          bool                                    `json:"schedules_work"`
	ExecutesWork           bool                                    `json:"executes_work"`
	ApprovesWork           bool                                    `json:"approves_work"`
	ClaimsAuthorityAdvance bool                                    `json:"claims_authority_advance"`
...
type AtlasPolicyVersionReplayRejectionCase struct {
	ID                   string `json:"id"`
	TicketSHA256         string `json:"ticket_sha256"`
	TicketPolicyVersion  string `json:"ticket_policy_version"`
	CurrentPolicyVersion string `json:"current_policy_version"`
	ExpectedDecision     string `json:"expected_decision"`
	RejectionReason      string `json:"rejection_reason"`
}

type AtlasPolicyVersionReplayRejectionFixture struct {
	Schema                   string                                  `json:"schema"`
	Status                   string                                  `json:"status"`
	SourceInputPath          string                                  `json:"source_input_path"`
	SourceInputDigest        string                                  `json:"source_input_digest"`
	...
	RejectedCases            int                                     `json:"rejected_cases"`
	SafeToAccept             bool                                    `json:"safe_to_accept"`
	AllStaleVersionsRejected bool                                    `json:"all_stale_versions_rejected"`
	Cases                    []AtlasPolicyVersionReplayRejectionCase `json:"cases"`
	SchedulesWork            bool                                    `json:"schedules_work"`
	ExecutesWork             bool                                    `json:"executes_work"`
	ApprovesWork             bool                                    `json:"approves_work"`
...
type AtlasCommandCompactRejectionReasonInput struct {
	Schema                 string                                   `json:"schema"`
	Status                 string                                   `json:"status"`
	Cases                  []AtlasCommandCompactRejectionReasonCase `json:"cases"`
	SchedulesWork          bool                                     `json:"schedules_work"`
	ExecutesWork           bool                                     `json:"executes_work"`
	ApprovesWork           bool                                     `json:"approves_work"`
	ClaimsAuthorityAdvance bool                                     `json:"claims_authority_advance"`
...
type AtlasCommandCompactRejectionReasonCase struct {
	ID                       string `json:"id"`
	CommandCompactStatusPath string `json:"command_compact_status_path"`
	CovenantNativeReason     string `json:"covenant_native_reason"`
	CommandCompactReason     string `json:"command_compact_reason"`
}

type AtlasCommandCompactRejectionReasonFixture struct {
	Schema                 string                                   `json:"schema"`
	Status                 string                                   `json:"status"`
	SourceInputPath        string                                   `json:"source_input_path"`
	SourceInputDigest      string                                   `json:"source_input_digest"`
	CaseCount              int                                      `json:"case_count"`
	ReasonsRendered        bool                                     `json:"reasons_rendered"`
	Cases                  []AtlasCommandCompactRejectionReasonCase `json:"cases"`
	SchedulesWork          bool                                     `json:"schedules_work"`
	ExecutesWork           bool                                     `json:"executes_work"`
	ApprovesWork           bool                                     `json:"approves_work"`
...
type AtlasBlueprintTicketSchemaCompatibilityLedgerInput struct {
	Schema                 string                                               `json:"schema"`
	Status                 string                                               `json:"status"`
	Entries                []AtlasBlueprintTicketSchemaCompatibilityLedgerEntry `json:"entries"`
	SchedulesWork          bool                                                 `json:"schedules_work"`
	ExecutesWork           bool                                                 `json:"executes_work"`
	ApprovesWork           bool                                                 `json:"approves_work"`
	ClaimsAuthorityAdvance bool                                                 `json:"claims_authority_advance"`
...
type AtlasBlueprintTicketSchemaCompatibilityLedgerEntry struct {
	ID                    string   `json:"id"`
	BlueprintTicketSchema string   `json:"blueprint_ticket_schema"`
	CovenantTicketSchema  string   `json:"covenant_ticket_schema"`
	CommandTicketSchema   string   `json:"command_ticket_schema"`
	RequiredFields        []string `json:"required_fields"`
	Compatible            bool     `json:"compatible"`
}

type AtlasBlueprintTicketSchemaCompatibilityLedger struct {
	Schema                 string                                               `json:"schema"`
	Status                 string                                               `json:"status"`
	SourceInputPath        string                                               `json:"source_input_path"`
	SourceInputDigest      string                                               `json:"source_input_digest"`
...
type AtlasTicketSchemaCompatibilityLedgerInput struct {
	Schema                 string                                      `json:"schema"`
	Status                 string                                      `json:"status"`
	Entries                []AtlasTicketSchemaCompatibilityLedgerEntry `json:"entries"`
	SchedulesWork          bool                                        `json:"schedules_work"`
	ExecutesWork           bool                                        `json:"executes_work"`
	ApprovesWork           bool                                        `json:"approves_work"`
	ClaimsAuthorityAdvance bool                                        `json:"claims_authority_advance"`
...
type AtlasTicketSchemaCompatibilityLedgerEntry struct {
	ID             string   `json:"id"`
...
type AtlasTicketSchemaCompatibilityLedger struct {
	Schema                 string                                      `json:"schema"`
	Status                 string                                      `json:"status"`
	SourceInputPath        string                                      `json:"source_input_path"`
	SourceInputDigest      string                                      `json:"source_input_digest"`
...
type AtlasFoundryTicketSchemaCompatibilityLedgerInput struct {
	Schema                 string                                             `json:"schema"`
	Status                 string                                             `json:"status"`
	Entries                []AtlasFoundryTicketSchemaCompatibilityLedgerEntry `json:"entries"`
	SchedulesWork          bool                                               `json:"schedules_work"`
	ExecutesWork           bool                                               `json:"executes_work"`
	ApprovesWork           bool                                               `json:"approves_work"`
	ClaimsAuthorityAdvance bool                                               `json:"claims_authority_advance"`
...
type AtlasFoundryTicketSchemaCompatibilityLedgerEntry struct {
	ID             string   `json:"id"`
	ProducerSchema string   `json:"producer_schema"`
	ConsumerSchema string   `json:"consumer_schema"`
	RequiredFields []string `json:"required_fields"`
...
type AtlasFoundryTicketSchemaCompatibilityLedger struct {
	Schema                 string                                             `json:"schema"`
	Status                 string                                             `json:"status"`
	SourceInputPath        string                                             `json:"source_input_path"`
	SourceInputDigest      string                                             `json:"source_input_digest"`
...
type AtlasCommandTicketSchemaCompatibilityLedgerInput struct {
	Schema                 string                                             `json:"schema"`
	Status                 string                                             `json:"status"`
	Entries                []AtlasCommandTicketSchemaCompatibilityLedgerEntry `json:"entries"`
	SchedulesWork          bool                                               `json:"schedules_work"`
	ExecutesWork           bool                                               `json:"executes_work"`
	ApprovesWork           bool                                               `json:"approves_work"`
	ClaimsAuthorityAdvance bool                                               `json:"claims_authority_advance"`
...
type AtlasCommandTicketSchemaCompatibilityLedgerEntry struct {
	ID             string   `json:"id"`
	ProducerSchema string   `json:"producer_schema"`
	ConsumerSchema string   `json:"consumer_schema"`
	RequiredFields []string `json:"required_fields"`
...
type AtlasCommandTicketSchemaCompatibilityLedger struct {
	Schema                 string                                             `json:"schema"`
	Status                 string                                             `json:"status"`
	SourceInputPath        string                                             `json:"source_input_path"`
	SourceInputDigest      string                                             `json:"source_input_digest"`
...
type AtlasFoundryCanonicalImportFixture struct {
	Schema                           string                            `json:"schema"`
	Status                           string                            `json:"status"`
	WorkgraphID                      string                            `json:"workgraph_id"`
	TargetInstance                   string                            `json:"target_instance"`
	...
	CanonicalContractField           string                            `json:"canonical_contract_field"`
	AcceptedCanonicalImport          bool                              `json:"accepted_canonical_import"`
	CanonicalWorkgraphFieldsConsumed bool                              `json:"canonical_workgraph_fields_consumed"`
	RejectedAliasCount               int                               `json:"rejected_alias_count"`
	RejectedAliases                  []AtlasFoundryRejectedSchemaAlias `json:"rejected_aliases"`
...
type AtlasFoundryRejectedSchemaAlias struct {
