...
- Atlas workgraph: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-11/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-12/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-hardening-12
- total nodes: 40
- completed nodes: 11
- ready nodes: 29
- blocked nodes: 0
