...
- Current workgraph: `docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-03/workgraph-after.json`
- Current readback: `docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-04/resume-recommendation-readback.json`

Current status:
- Completed nodes: 3 / 40
- Ready nodes: 37
- Elapsed minutes at latest checkpoint: 48
- Minimum minutes: 120
...
- Checkpoint count: 3
- Next executable node: `mission-recommendation-hardening-04`
...
Exact next action:
- Emit Foundry import for mission-recommendation-hardening-04 and execute exactly one active node.
