...
- Atlas workgraph: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-08/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-09/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-hardening-09
- total nodes: 40
- completed nodes: 8
- ready nodes: 32
- blocked nodes: 0
