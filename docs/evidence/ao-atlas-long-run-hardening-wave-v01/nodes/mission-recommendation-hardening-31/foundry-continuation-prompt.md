...
- Atlas workgraph: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-30/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-31/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-hardening-31
- total nodes: 40
- completed nodes: 30
- ready nodes: 10
- blocked nodes: 0
