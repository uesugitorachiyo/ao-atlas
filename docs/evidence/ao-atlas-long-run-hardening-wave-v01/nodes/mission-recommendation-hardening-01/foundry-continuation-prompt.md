...
- Atlas workgraph: docs/evidence/ao-atlas-long-run-hardening-wave-v01/recommendation-workgraph.json
- Foundry import: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-01/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-hardening-01
- total nodes: 40
- completed nodes: 0
- ready nodes: 40
- blocked nodes: 0
