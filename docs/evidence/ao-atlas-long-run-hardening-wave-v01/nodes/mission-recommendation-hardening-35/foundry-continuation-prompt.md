...
- Atlas workgraph: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-34/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-35/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-hardening-35
- total nodes: 40
- completed nodes: 34
- ready nodes: 6
- blocked nodes: 0
