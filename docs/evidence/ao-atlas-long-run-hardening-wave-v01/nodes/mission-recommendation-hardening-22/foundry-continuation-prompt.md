...
- Atlas workgraph: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-21/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-long-run-hardening-wave-v01/nodes/mission-recommendation-hardening-22/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-hardening-22
- total nodes: 40
- completed nodes: 21
- ready nodes: 19
- blocked nodes: 0
