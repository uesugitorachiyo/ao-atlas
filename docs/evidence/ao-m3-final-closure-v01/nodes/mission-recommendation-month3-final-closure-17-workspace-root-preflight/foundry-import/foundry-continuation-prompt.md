...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-16-no-promotion-rsi-matrix/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-17-workspace-root-preflight/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-17-workspace-root-preflight
- total nodes: 30
- completed nodes: 16
- ready nodes: 14
- blocked nodes: 0
