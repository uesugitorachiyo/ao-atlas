...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-17-workspace-root-preflight/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-18-command-thin-client/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-18-command-thin-client
- total nodes: 30
- completed nodes: 17
- ready nodes: 13
- blocked nodes: 0
