...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-14-compaction-resume-generator/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-15-architecture-source-truth/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-15-architecture-source-truth
- total nodes: 30
- completed nodes: 14
- ready nodes: 16
- blocked nodes: 0
