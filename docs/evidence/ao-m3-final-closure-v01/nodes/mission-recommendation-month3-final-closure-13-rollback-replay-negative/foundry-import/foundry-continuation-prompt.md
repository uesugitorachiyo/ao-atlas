...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-12-provider-model-provenance/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-13-rollback-replay-negative/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-13-rollback-replay-negative
- total nodes: 30
- completed nodes: 12
- ready nodes: 18
- blocked nodes: 0
