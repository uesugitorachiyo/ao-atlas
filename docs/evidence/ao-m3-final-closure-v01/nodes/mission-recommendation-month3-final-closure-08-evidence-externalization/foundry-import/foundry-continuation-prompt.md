...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-07-schema-owner-registry/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-08-evidence-externalization/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-08-evidence-externalization
- total nodes: 30
- completed nodes: 7
- ready nodes: 23
- blocked nodes: 0
