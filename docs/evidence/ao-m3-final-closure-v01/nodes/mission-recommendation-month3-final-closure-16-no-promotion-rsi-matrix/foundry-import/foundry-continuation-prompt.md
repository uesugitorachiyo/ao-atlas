...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-15-architecture-source-truth/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-16-no-promotion-rsi-matrix/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-16-no-promotion-rsi-matrix
- total nodes: 30
- completed nodes: 15
- ready nodes: 15
- blocked nodes: 0
