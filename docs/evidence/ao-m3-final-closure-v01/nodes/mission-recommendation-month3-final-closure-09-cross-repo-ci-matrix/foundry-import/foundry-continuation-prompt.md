...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-08-evidence-externalization/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-09-cross-repo-ci-matrix/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-09-cross-repo-ci-matrix
- total nodes: 30
- completed nodes: 8
- ready nodes: 22
- blocked nodes: 0
