...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-05-real-run-acceptance/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-06-control-plane-observer/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-06-control-plane-observer
- total nodes: 30
- completed nodes: 5
- ready nodes: 25
- blocked nodes: 0
