...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-21-blueprint-auth-digest/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-22-ao2-approval-integrity/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-22-ao2-approval-integrity
- total nodes: 30
- completed nodes: 21
- ready nodes: 9
- blocked nodes: 0
