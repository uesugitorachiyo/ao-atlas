...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-27-control-plane-index/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-28-rollback-failure-drill/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-28-rollback-failure-drill
- total nodes: 30
- completed nodes: 27
- ready nodes: 3
- blocked nodes: 0
