...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-04-non-ao-dry-run-replay/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-05-real-run-acceptance/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-05-real-run-acceptance
- total nodes: 30
- completed nodes: 4
- ready nodes: 26
- blocked nodes: 0
