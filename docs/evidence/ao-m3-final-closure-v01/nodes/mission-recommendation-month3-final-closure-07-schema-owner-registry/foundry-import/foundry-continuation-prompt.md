...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-06-control-plane-observer/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-07-schema-owner-registry/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-07-schema-owner-registry
- total nodes: 30
- completed nodes: 6
- ready nodes: 24
- blocked nodes: 0
