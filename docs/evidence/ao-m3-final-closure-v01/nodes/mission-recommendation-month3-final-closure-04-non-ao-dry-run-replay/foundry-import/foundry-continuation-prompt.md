...
- Atlas workgraph: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-03-terminal-digest-binding/workgraph-after.json
- Foundry import: docs/evidence/ao-m3-final-closure-v01/nodes/mission-recommendation-month3-final-closure-04-non-ao-dry-run-replay/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-final-closure-04-non-ao-dry-run-replay
- total nodes: 30
- completed nodes: 3
- ready nodes: 27
- blocked nodes: 0
