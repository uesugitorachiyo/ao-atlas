...
- Atlas workgraph: docs/evidence/ao-stack-consolidation-month1-wave-v01/progress/after-node-24/workgraph-after-complete.json
- Foundry import: target/ao-stack-consolidation-month1-node-25/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-consolidation-month1-25
- total nodes: 36
- completed nodes: 24
- ready nodes: 12
- blocked nodes: 0
