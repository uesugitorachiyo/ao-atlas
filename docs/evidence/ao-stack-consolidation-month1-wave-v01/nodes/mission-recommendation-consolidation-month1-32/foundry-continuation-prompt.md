...
- Atlas workgraph: docs/evidence/ao-stack-consolidation-month1-wave-v01/progress/after-node-31/workgraph-after-complete.json
- Foundry import: target/ao-stack-consolidation-month1-node-32/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-consolidation-month1-32
- total nodes: 36
- completed nodes: 31
- ready nodes: 5
- blocked nodes: 0
