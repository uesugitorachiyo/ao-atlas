...
- Atlas workgraph: docs/evidence/ao-stack-consolidation-month1-wave-v01/progress/after-node-23/workgraph-after-complete.json
- Foundry import: target/ao-stack-consolidation-month1-node-24/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-consolidation-month1-24
- total nodes: 36
- completed nodes: 23
- ready nodes: 13
- blocked nodes: 0
