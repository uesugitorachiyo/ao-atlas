...
- Atlas workgraph: docs/evidence/ao-stack-consolidation-month1-wave-v01/progress/after-node-21/workgraph-after-complete.json
- Foundry import: target/ao-stack-consolidation-month1-node-22/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-consolidation-month1-22
- total nodes: 36
- completed nodes: 21
- ready nodes: 15
- blocked nodes: 0
