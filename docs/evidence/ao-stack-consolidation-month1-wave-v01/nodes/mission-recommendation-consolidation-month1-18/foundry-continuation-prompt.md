...
- Atlas workgraph: docs/evidence/ao-stack-consolidation-month1-wave-v01/progress/after-node-17/workgraph-after-complete.json
- Foundry import: target/ao-stack-consolidation-month1-node-18/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-consolidation-month1-18
- total nodes: 36
- completed nodes: 17
- ready nodes: 19
- blocked nodes: 0
