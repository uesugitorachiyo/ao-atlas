...
- Atlas workgraph: docs/evidence/ao-stack-month5-beta-operations-v01/recommendation-workgraph.json
- Foundry import: docs/evidence/ao-stack-month5-beta-operations-v01/nodes/mission-recommendation-month5-beta-operations-01/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month5-beta-operations-01
- total nodes: 40
- completed nodes: 0
- ready nodes: 40
- blocked nodes: 0
