...
- Atlas import: docs/evidence/ao-atlas-feature-depth-wave-v01/recommendation-wave.json
- Atlas workgraph: docs/evidence/ao-atlas-feature-depth-wave-v01/nodes/mission-recommendation-feature-depth-next-wave-01/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-feature-depth-wave-v01/nodes/mission-recommendation-feature-depth-next-wave-02/foundry-import.json
- Mission continuation evidence: docs/evidence/ao-atlas-feature-depth-wave-v01/nodes/mission-recommendation-feature-depth-next-wave-01/recommendation-readback-after.json

Current Atlas readback:
- first safe node: mission-recommendation-feature-depth-next-wave-02
- total nodes: 40
- completed nodes: 1
- ready nodes: 39
- blocked nodes: 0
