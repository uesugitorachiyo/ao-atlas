...
- Atlas workgraph: docs/evidence/ao-atlas-feature-depth-wave-v01/nodes/mission-recommendation-feature-depth-next-wave-12/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-feature-depth-wave-v01/nodes/mission-recommendation-feature-depth-next-wave-13/foundry-import.json
- Mission continuation evidence: docs/evidence/ao-atlas-feature-depth-wave-v01/lease-start.json

Current Atlas readback:
- first safe node: mission-recommendation-feature-depth-next-wave-13
- total nodes: 40
- completed nodes: 12
- ready nodes: 28
- blocked nodes: 0
