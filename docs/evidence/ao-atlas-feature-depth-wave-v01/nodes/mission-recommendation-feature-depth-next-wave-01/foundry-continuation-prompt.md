...
- Atlas workgraph: docs/evidence/ao-atlas-feature-depth-wave-v01/recommendation-workgraph.json
- Foundry import: docs/evidence/ao-atlas-feature-depth-wave-v01/nodes/mission-recommendation-feature-depth-next-wave-01/foundry-import.json
- Mission continuation evidence: docs/evidence/ao-atlas-feature-depth-wave-v01/recommendation-readback.json

Current Atlas readback:
- first safe node: mission-recommendation-feature-depth-next-wave-01
- total nodes: 40
- completed nodes: 0
- ready nodes: 40
- blocked nodes: 0
