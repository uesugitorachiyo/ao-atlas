...
Source artifacts:
- Blueprint pack: examples/valid/blueprint-import-low-risk-code/blueprint-pack
- Atlas import: blueprint-import.json
- Atlas workgraph: workgraph.json
- Foundry import: foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: low-risk-code-rehearsal-candidate-node
- total nodes: 1
- completed nodes: 0
- ready nodes: 1
- blocked nodes: 0
