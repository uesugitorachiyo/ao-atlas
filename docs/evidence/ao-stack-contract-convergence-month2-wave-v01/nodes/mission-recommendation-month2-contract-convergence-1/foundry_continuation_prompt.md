...
- Atlas workgraph: docs/evidence/ao-stack-contract-convergence-month2-wave-v01/recommendation-workgraph.json
- Foundry import: docs/evidence/ao-stack-contract-convergence-month2-wave-v01/nodes/mission-recommendation-month2-contract-convergence-1/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month2-contract-convergence-1
- total nodes: 40
- completed nodes: 0
- ready nodes: 40
- blocked nodes: 0
