...
- Atlas workgraph: docs/evidence/ao-stack-p0b-contract-convergence-wave-v01/nodes/mission-recommendation-p0b-contract-convergence-03/workgraph-after-complete.json
- Foundry import: docs/evidence/ao-stack-p0b-contract-convergence-wave-v01/nodes/mission-recommendation-p0b-contract-convergence-04/foundry-import/foundry-import.json
- Mission continuation evidence: docs/evidence/ao-stack-p0b-contract-convergence-wave-v01/lease-start.json

Current Atlas readback:
- first safe node: mission-recommendation-p0b-contract-convergence-04
- total nodes: 30
- completed nodes: 3
- ready nodes: 27
- blocked nodes: 0
