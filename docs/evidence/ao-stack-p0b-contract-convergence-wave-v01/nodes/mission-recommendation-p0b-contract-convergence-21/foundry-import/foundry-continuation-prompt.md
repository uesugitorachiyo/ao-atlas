...
- Atlas workgraph: docs/evidence/ao-stack-p0b-contract-convergence-wave-v01/nodes/mission-recommendation-p0b-contract-convergence-20/workgraph-after-complete.json
- Foundry import: docs/evidence/ao-stack-p0b-contract-convergence-wave-v01/nodes/mission-recommendation-p0b-contract-convergence-21/foundry-import/foundry-import.json
...
- first safe node: mission-recommendation-p0b-contract-convergence-21
- total nodes: 30
- completed nodes: 20
- ready nodes: 10
- blocked nodes: 0
