...
- Atlas workgraph: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-12/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-13/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-next-13
- total nodes: 40
- completed nodes: 12
- ready nodes: 28
- blocked nodes: 0
