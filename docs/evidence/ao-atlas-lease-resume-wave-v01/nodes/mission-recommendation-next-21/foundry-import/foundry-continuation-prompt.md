...
- Atlas workgraph: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-20/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-21/foundry-import/foundry-import.json
- Mission continuation evidence: docs/evidence/ao-atlas-lease-resume-wave-v01/lease-start.json

Current Atlas readback:
- first safe node: mission-recommendation-next-21
- total nodes: 40
- completed nodes: 20
- ready nodes: 20
- blocked nodes: 0
