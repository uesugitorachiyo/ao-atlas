...
- Atlas workgraph: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-13/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-14/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-next-14
- total nodes: 40
- completed nodes: 13
- ready nodes: 27
- blocked nodes: 0
