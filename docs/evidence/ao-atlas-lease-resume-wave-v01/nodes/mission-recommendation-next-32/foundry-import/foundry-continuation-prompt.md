...
- Atlas workgraph: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-31/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-32/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-next-32
- total nodes: 40
- completed nodes: 31
- ready nodes: 9
- blocked nodes: 0
