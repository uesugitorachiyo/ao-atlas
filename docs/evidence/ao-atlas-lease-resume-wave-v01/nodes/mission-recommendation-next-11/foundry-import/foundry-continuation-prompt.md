...
- Atlas workgraph: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-10/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-11/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-next-11
- total nodes: 40
- completed nodes: 10
- ready nodes: 30
- blocked nodes: 0
