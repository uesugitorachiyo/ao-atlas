...
- Atlas workgraph: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-03/workgraph-after.json
- Foundry import: docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-04/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-next-04
- total nodes: 40
- completed nodes: 3
- ready nodes: 37
- blocked nodes: 0
