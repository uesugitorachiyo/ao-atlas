...
- Current workgraph: `docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-31/workgraph-after.json`
- Current readback: `docs/evidence/ao-atlas-lease-resume-wave-v01/recommendation-readback.json`

Current status:
- Completed nodes: 31 / 40
- Ready nodes: 9
- Elapsed minutes at latest checkpoint: 376
- Minimum minutes: 120
...
- Checkpoint count: 31
- Next executable node: `mission-recommendation-next-32`
...
Exact next action:
- Emit Foundry import for mission-recommendation-next-32 and execute exactly one active node.
