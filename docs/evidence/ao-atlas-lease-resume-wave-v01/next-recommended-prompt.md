...
- Current workgraph: `docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-32/workgraph-after.json`
- Current readback: `docs/evidence/ao-atlas-lease-resume-wave-v01/recommendation-readback.json`

Current status:
- Completed nodes: 32 / 40
- Ready nodes: 8
- Elapsed minutes at latest checkpoint: 387
- Minimum minutes: 120
...
- Checkpoint count: 32
- Next executable node: `mission-recommendation-next-33`
...
Exact next action:
- Emit Foundry import for mission-recommendation-next-33 and execute exactly one active node.
