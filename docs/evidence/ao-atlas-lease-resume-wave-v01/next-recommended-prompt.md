...
- Current workgraph: `docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-18/workgraph-after.json`
...
- Checkpoint count: 18
- Next executable node: `mission-recommendation-next-19`
...
Exact next action:
- Emit Foundry import for mission-recommendation-next-19 and execute exactly one active node.
