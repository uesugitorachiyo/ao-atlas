...
- Current workgraph: `docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-20/workgraph-after.json`
- Current readback: `docs/evidence/ao-atlas-lease-resume-wave-v01/recommendation-readback.json`

Current status:
- Completed nodes: 20 / 40
- Ready nodes: 20
...
- Checkpoint count: 20
- Next executable node: `mission-recommendation-next-21`
...
Exact next action:
- Emit Foundry import for mission-recommendation-next-21 and execute exactly one active node.
