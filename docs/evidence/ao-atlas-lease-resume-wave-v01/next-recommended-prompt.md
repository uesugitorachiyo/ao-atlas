...
- Current workgraph: `docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-16/workgraph-after.json`
...
- Checkpoint count: 16
- Next executable node: `mission-recommendation-next-17`
...
Exact next action:
- Emit Foundry import for mission-recommendation-next-17 and execute exactly one active node.
