...
- Current workgraph: `docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-27/workgraph-after.json`
- Current readback: `docs/evidence/ao-atlas-lease-resume-wave-v01/recommendation-readback.json`

Current status:
- Completed nodes: 27 / 40
- Ready nodes: 13
...
- Checkpoint count: 27
- Next executable node: `mission-recommendation-next-28`
...
Exact next action:
- Emit Foundry import for mission-recommendation-next-28 and execute exactly one active node.
