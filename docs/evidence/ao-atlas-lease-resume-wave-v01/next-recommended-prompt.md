...
- Current workgraph: `docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-26/workgraph-after.json`
...
- Checkpoint count: 26
- Next executable node: `mission-recommendation-next-27`
...
Exact next action:
- Emit Foundry import for mission-recommendation-next-27 and execute exactly one active node.
