...
- Current workgraph: `docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-30/workgraph-after.json`
- Current readback: `docs/evidence/ao-atlas-lease-resume-wave-v01/recommendation-readback.json`

Current status:
- Completed nodes: 30 / 40
- Ready nodes: 10
- Elapsed minutes at latest checkpoint: 364
- Minimum minutes: 120
...
- Checkpoint count: 30
- Next executable node: `mission-recommendation-next-31`
...
Exact next action:
- Emit Foundry import for mission-recommendation-next-31 and execute exactly one active node.
