...
- Current workgraph: `docs/evidence/ao-atlas-lease-resume-wave-v01/nodes/mission-recommendation-next-25/workgraph-after.json`
- Current readback: `docs/evidence/ao-atlas-lease-resume-wave-v01/recommendation-readback.json`

Current status:
- Completed nodes: 25 / 40
- Ready nodes: 15
...
- Checkpoint count: 25
- Next executable node: `mission-recommendation-next-26`
...
Exact next action:
- Emit Foundry import for mission-recommendation-next-26 and execute exactly one active node.
