...
- Atlas workgraph: docs/evidence/ao-stack-golden-path-month3-wave-v01/recommendation-workgraph.json
- Foundry import: docs/evidence/ao-stack-golden-path-month3-wave-v01/nodes/mission-recommendation-month3-golden-path-1/foundry-import/foundry-import.json

Current Atlas readback:
- first safe node: mission-recommendation-month3-golden-path-1
- total nodes: 40
- completed nodes: 0
- ready nodes: 40
- blocked nodes: 0
