...
- Preserve only the historical `docs/evidence/` prefixes required by public tests, contracts, operator gates, and `docs/evidence-path-map.json`; never rewrite them to support a current claim or revive and reinterpret an earlier wave.
