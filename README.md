...
`public_safe_broad_RSI_governed_campaign_segment_05_evidence`: docs-only, test-only,
...
segment-05 campaign evidence and readback alignment. The next denied class is
`broad_RSI`.
...
`docs/evidence/broad-rsi-campaign-segment-05-readback-handoff/`. The approved
...
readbacks while broad_RSI remains denied." The highest proven live class is
