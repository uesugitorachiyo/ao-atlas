...
go run ./cmd/atlas mission import --record examples/valid/ao-mission/mission-record.json --command-status examples/valid/ao-mission/command-status.json --artifact-manifest examples/valid/ao-mission/artifact-manifest.json --route-history examples/valid/ao-mission/route-history.json --scheduler-recovery examples/valid/ao-mission/scheduler-recovery-readback.json --ledger-compaction examples/valid/ao-mission/ledger-compaction-readback.json --mission-archive examples/valid/ao-mission/mission-archive.json --out .atlas-local/ao-mission-import.json
...
scheduler-recovery, ledger-compaction, and Mission archive provenance into
...
grants no execution authority. Mission archive provenance is accepted only as
digest-bound readback evidence. Optional Mission provenance must remain read-only;
any route, scheduler-recovery, ledger-compaction, or Mission archive readback that claims
